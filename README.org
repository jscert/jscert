...
*** TODO Add a github link below.
    :LOGBOOK:
    - State "TODO"       from ""           [2013-12-10 Tue 16:12]
    :END:
*** The developer option

    You can get the latest source from [[http://github.com/][here]].
...
**** TODO Update these instructions with the right src directory.
      :LOGBOOK:
      - State "TODO"       from ""           [2013-12-10 Tue 17:00]
      :END:
**** TODO Can we fix it so we don't have to run make twice? Please?
     :LOGBOOK:
     - State "TODO"       from ""           [2013-12-10 Tue 17:06]
     :END:
**** Basic Install
...
#+end_src
      ...
      Yes, you do actually have to run =make= twice. The first one,
      will fail. Also note that the following error is normal and can
      be ignored:
...
**** Testing Install
      ...
      using JSRef, you will also need python. Ubuntu usres can do:
...
**** DONE Alan: What follows is my first draft. Check it over?  --gds
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2014-01-15 Wed 15:49]
     - State "TODO"       from ""           [2014-01-06 Mon 12:49]
     :END:
...
#+end_src
    ...
    collate those results into a pretty HTML page, you can do the following:
...
#+end_src
    ...
    is =make_simple_report= which can be used to produce a report of
    all the test runs that meet our criteria of being "interesting".
...
*** Bisect
    ...
    First, run the programs using the bisect-ready version of the
    interpreter:
