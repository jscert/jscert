...
interp/src/interpreter.ml: coq/JsInterpreterExtraction.vo
	# The following two lines are here temporary.  They just replace all [raise Not_found] generated by Coq by a [failwith] followed by a line number, which is much easier to use for debuging purpose. -- Martin.
