...
runhaskell make_simple_report.hs --querytype=StdOutErrNotLikeAny --reportname=t262LS5nightlynonknownaborts --reportcomment="Checking last night's run for aborts which are not syntax errors, parser errors or not implemented yet errors"
